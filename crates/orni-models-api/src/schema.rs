...
pub async fn ensure_schema(db: &PgPool) -> anyhow::Result<()> {
    ...
    sqlx::query(r#"
        ...
        VALUES
            ('00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 'llama-3-8b', 'Llama 3.1 8B', 'Meta''s fast and capable open-source model.', 'You are a helpful AI assistant.', 'llama-3.1-8b-instant', 'llama-3.1-8b-instant', 'live', 50000, 'Technology', TRUE, TRUE, 5),
            ('00000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000001', 'qwen-32b', 'Qwen3 32B', 'Alibaba''s powerful reasoning model.', 'You are a helpful AI assistant.', 'qwen/qwen3-32b', 'qwen/qwen3-32b', 'live', 50000, 'Technology', TRUE, TRUE, 5),
            ('00000000-0000-0000-0000-000000000012', '00000000-0000-0000-0000-000000000001', 'llama-3-70b', 'Llama 3.3 70B', 'Meta''s most capable open model.', 'You are a helpful AI assistant.', 'llama-3.3-70b-versatile', 'llama-3.3-70b-versatile', 'live', 200000, 'Technology', TRUE, TRUE, 3),
